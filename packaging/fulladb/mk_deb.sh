...
if [ ! -e debian/usr/share/fulladb ]; then
    mkdir -p debian/usr/share/fulladb
fi
cp ../../code/server/sql/db.sql debian/usr/share/fulladb

# pack manpage
if [ ! -e debian/usr/share/man/man1 ]; then
    mkdir -p debian/usr/share/man/man1
fi
cp fulladb.1 debian/usr/share/man/man1/
gzip -n --best debian/usr/share/man/man1/*.1

# pack changelog and copyright
if [ ! -e debian/usr/share/doc/fulladb ]; then
    mkdir -p debian/usr/share/doc/fulladb
fi
cp changelog        debian/usr/share/doc/fulladb/
cp changelog.Debian debian/usr/share/doc/fulladb/
gzip -n --best debian/usr/share/doc/fulladb/changelog
gzip -n --best debian/usr/share/doc/fulladb/changelog.Debian
cp copyright debian/usr/share/doc/fulladb/
...
chmod 644 debian/usr/share/fulladb/db.sql
chmod 644 debian/usr/share/doc/fulladb/changelog*
chmod 644 debian/usr/share/doc/fulladb/copyright
chmod 644 debian/usr/share/man/man1/fulladb.1.gz
...
rm debian/usr/share/man/man1/fulladb.1.gz
rm debian/usr/share/doc/fulladb/changelog.gz
rm debian/usr/share/doc/fulladb/changelog.Debian.gz
rm debian/usr/share/doc/fulladb/copyright
